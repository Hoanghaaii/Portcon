...
const products = [
  {
    ...
    price: '100.000 VNĐ',
    imageUrls: ['/chiangan1.png', '/pageImg.jpg', '/pageImg.jpg'],
    inStock: true,
  },
  {
    id: 7,
    ...
    price: '200.000 VNĐ',
    imageUrls: ['/chiangan2.png', '/pageImg.jpg'],
    inStock: true,
  },
  {
    id: 8,
...
const Page: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-2xl font-bold mb-4 text-center text-blue-900">Danh Sách Sản Phẩm 40FT</h1>
